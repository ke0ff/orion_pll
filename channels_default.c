...
//		0x00A00000, 0x00008011, 0x00004e42, 0x000004b3, 0x0095042C, 0x00580005,		// 10 MHz Reference Clock and 1600 MHz, -1dBm
		// Ch 01
//		0x009B0010, 0x08008029, 0x00004E42, 0x000004B3, 0x00C5003C, 0x00580005,		// 10 MHz Reference Clock and 194.0 MHz (RX) +5dBm
...
//		0x00A00000, 0x00008011, 0x00004E42, 0x000004B3, 0x00D5003C, 0x00580005,		// 10 MHz Reference Clock and 100 MHz (RX) +5dBm, 10KHz channel, MTLD, PS 4/5
#endif
#if NUM_CHAN > 12
		// Ch 12
...
//		0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,		// null channel
		...
		// Ch 90
		0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,		// null channel
//		0x00960000, 0x08008011, 0x00004E42, 0x000004B3, 0x0085003c, 0x00580005,		// 10 MHz Reference Clock and 3000.0 MHz (RX) -4dBm
#endif
#if NUM_CHAN > 91
		// Ch 91
		0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,		// null channel
		...
		// Ch 98
		0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,		// null channel
//		0x002e0020, 0x080080c9, 0x00004e42, 0x000004b3, 0x009c802c, 0x00580005,		// 1152 MHz out, 25MHz ref 1mhz chspc, -1dbm out
#endif
#if NUM_CHAN > 99
		// Ch 99
		0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF,		// null channel
//		0x00730010, 0x08008029, 0x00004e42, 0x000004b3, 0x0095002c, 0x00580005,		// 1152 MHz out, 10MHz ref 1mhz chspc, -1dbm out
#endif
	};
